...
A Perceptron can be used to make decisions based on multiple inputs. Let's look at a practical example,
 where we take a perceptron with weights $0.5$ and $-0.8$ 
and bias $0.3$

This Perceptron takes two inputs and makes a decision based on their values.
 The weights and bias determine how the Perceptron interprets the inputs.
...
The beauty of this approach is that by adjusting the weights and bias,
 we can create different decision boundaries for different types of problems.
